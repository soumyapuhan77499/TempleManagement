        ...
        <div class="col-lg-12 col-md-12">
            <div class="custom-card main-content-body-profile">
                <div class="main-content-body tab-pane border-top-0" id="bank">
                    ...
                    @endif
                    <form action="{{ url('templeuser/savebankdetails')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{-- @method('PUT') --}}
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="bank_name"
                                                        value="{{$bankdata->bank_name ?? ''}}" id="bank_name"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="account_no"
                                                           value="{{$bankdata->account_no ?? ''}}" id="account_no"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="ifsc_code"
                                                           value="{{$bankdata->ifsc_code ?? ''}}" id="ifsc_code"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="acc_holder_name"
                                                        value="{{$bankdata->acc_holder_name ?? ''}}" id="acc_holder_name"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="upi_id"
                                                        value="{{$bankdata->upi_id ?? ''}}" id="upi_id"
