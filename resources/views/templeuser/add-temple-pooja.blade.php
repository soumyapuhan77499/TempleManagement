												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" id="pooja_name" name="pooja_name" required>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
															<label for="pooja_price">Pooja Price <span style="color:red">*</span></label>
															<input type="text" class="form-control" id="pooja_price" name="pooja_price" required>
														</div>
													</div>
												</div>
												<div class="form-group">
													<label for="pooja_descp">Pooja Description</label>
													<textarea name="pooja_descp" class="form-control" id="pooja_descp"></textarea>
												</div>
