                                                        ...
                                                        @if (isset($groupedDarshans[$day]) && $groupedDarshans[$day]->count() > 0)
                                                            ...
                                                            @foreach ($groupedDarshans[$day] as $darshanIndex => $darshan)
                                                                ...
                                                                <form id="ritualUpdateForm{{ $darshan->id }}"
                                                                    ...
                                                                    <input type="hidden" name="darshan_id[]"
                                                                        value="{{ $darshan->id }}">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label for="darshan_name">Darshan
                                                                                        Name</label>
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="darshan_name[]"
                                                                                        value="{{ $darshan->darshan_name }}">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="form-group">
                                                                                    <label for="darshan_image">Darshan
                                                                                        Image</label>
                                                                                    <div class="d-flex align-items-center">
                                                                                        ...
                                                                                        @if (!empty($darshan->darshan_image))
                                                                                            <button type="button"
                                                                                                ...
                                                                                                data-bs-target="#imageModal{{ $darshanIndex }}">
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <div class="form-group">
                                                                                    <label for="darshan_start_time">Darshan
                                                                                        Start Time</label>
                                                                                    <div class="input-group">
                                                                                        <input type="time"
                                                                                            style="width: 60px"
                                                                                            class="form-control"
                                                                                            name="darshan_start_time[]"
                                                                                            value="{{ date('H:i', strtotime($darshan->darshan_start_time)) }}">
                                                                                        <select class="form-control"
                                                                                            name="darshan_start_period[]">
                                                                                            <option value="AM"
                                                                                                {{ $darshan->darshan_start_period == 'AM' ? 'selected' : '' }}>
                                                                                                AM</option>
                                                                                            <option value="PM"
                                                                                                {{ $darshan->darshan_start_period == 'PM' ? 'selected' : '' }}>
                                                                                                PM</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-md-2">
                                                                                <div class="form-group">
                                                                                    <label for="darshan_end_time">Darshan
                                                                                        End Time</label>
                                                                                    <div class="input-group">
                                                                                        <input type="time"
                                                                                            style="width: 60px"
                                                                                            class="form-control"
                                                                                            name="darshan_end_time[]"
                                                                                            value="{{ date('H:i', strtotime($darshan->darshan_end_time)) }}">
                                                                                        <select class="form-control"
                                                                                            name="darshan_end_period[]">
                                                                                            <option value="AM"
                                                                                                {{ $darshan->darshan_end_period == 'AM' ? 'selected' : '' }}>
                                                                                                AM</option>
                                                                                            <option value="PM"
                                                                                                {{ $darshan->darshan_end_period == 'PM' ? 'selected' : '' }}>
                                                                                                PM</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        <input type="text"
                                                                                            style="width: 60px"
                                                                                            class="form-control"
                                                                                            value="{{ $darshan->darshan_duration }}"
                                                                                            disabled>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-2 mt-4">
                                                                                <button type="button"
                                                                                    ...
                                                                                    onclick="document.getElementById('ritualUpdateForm{{ $darshan->id }}').submit();">
                                                                                    Update
                                                                                </button>
                                                                                ...
                                                                                <button type="button"
                                                                                    ...
                                                                                    onclick="confirmDelete({{ $darshan->id }})">
                                                                ...
                                                                <form id="delete-form-{{ $darshan->id }}"
                                                                    action="{{ route('templeuser.deleteDarshan', $darshan->id) }}"
                                                                ...
                                                                @if (!empty($darshan->darshan_image))
                                                                    <div class="modal fade"
                                                                        id="imageModal{{ $darshanIndex }}" tabindex="-1"
                                                                        aria-labelledby="imageModalLabel{{ $darshanIndex }}"
                                                                        aria-hidden="true">
                                                                        <div class="modal-dialog modal-md">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="imageModalLabel{{ $darshanIndex }}">
                                                                                        Darshan Image</h5>
                                                                                    <button type="button"
                                                                                        class="btn-close"
                                                                                ...
                                                                                <div class="modal-body text-center">
                                                                                    <img src="{{ asset($darshan->darshan_image) }}"
                                                                                        alt="Darshan Image"
                                                                                        class="img-fluid">
                                                                                </div>
                                                                            </div>
