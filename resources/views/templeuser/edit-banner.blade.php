...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">Edit Banner Image</span>
        </div>
        <div class="justify-content-center mt-2">
            <ol class="breadcrumb">
                <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Banner Image</li>
            </ol>
        </div>
    </div>
    <!-- /breadcrumb -->
            ...
            <div class="card">
                ...
                <div class="card-body pt-0 pt-4">
                    <form method="POST" enctype="multipart/form-data"
                        action="{{ route('templebanner.updateBanner', $banner->id) }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									@if ($banner->banner_video)
										<video width="100" height="80" controls style="margin-top: 5px; border-radius: 4px;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="banner_type" id="banner_type" class="form-control">
                                        <option value="web" {{ $banner->banner_type == 'web' ? 'selected' : '' }}>Web
                                        </option>
                                        <option value="app" {{ $banner->banner_type == 'app' ? 'selected' : '' }}>App
                                        </option>
                                    </select>
                                </div>
                            </div>
