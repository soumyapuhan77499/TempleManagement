                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="besha_name" name="besha_name" placeholder="Enter Besha Name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="items">Items</label>
                                    <select class="form-control select2" id="items" name="items[]" multiple="multiple" required>
