@extends('templeuser.layouts.app')
    ...
    @section('content')
					...
					<div class="breadcrumb-header justify-content-between">
						...
						<span class="main-content-title mg-b-0 mg-b-lg-1">Add News</span>
						</div>
								...
								<div class="col-12 col-sm-12">
									<div class="card">
										...
										<div class="card-body pt-0 pt-4">
											<form method="POST" action="{{ route('templenews.storeNews') }}">
												@csrf
												<div class="row">
													<div class="col-md-6">
												...
												<div class="form-group">
													<label for="notice_descp">Notice Description</label>
													<textarea name="notice_descp" class="form-control" id="notice_descp" placeholder="Enter Notice Description"></textarea>
												</div>
