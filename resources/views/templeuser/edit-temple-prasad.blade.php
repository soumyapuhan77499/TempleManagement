                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="time" class="form-control" name="prasad_start_time"
                                        value="{{ $templePrasad->prasad_start_time }}" required>
                                    <select class="form-control" name="prasad_start_period">
                                        <option value="AM"
                                            {{ $templePrasad->prasad_start_period == 'AM' ? 'selected' : '' }}>AM</option>
                                        <option value="PM"
                                            {{ $templePrasad->prasad_start_period == 'PM' ? 'selected' : '' }}>PM</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <input type="time" class="form-control" name="prasad_end_time"
                                        value="{{ $templePrasad->prasad_end_time }}" required>
                                    <select class="form-control" name="prasad_end_period">
                                        <option value="AM"
                                            {{ $templePrasad->prasad_end_period == 'AM' ? 'selected' : '' }}>AM</option>
                                        <option value="PM"
                                            {{ $templePrasad->prasad_end_period == 'PM' ? 'selected' : '' }}>PM</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="full_prasad_price"
                                    value="{{ $templePrasad->full_prasad_price }}" required>
                            </div>
                        </div>
                            ...
                            @foreach ($templePrasad->prasadItems as $item)
                                <div class="row mt-2 prasad-row" id="prasadRow_{{ $loop->index }}">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" name="prasad_name[]"
                                            value="{{ $item->prasad_name }}" required>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Prasad Price <span style="color:red">*</span></label>
                                        <input type="text" class="form-control" name="prasad_price[]"
                                            value="{{ $item->prasad_price }}" required>
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-danger mt-4 removePrasadField"
                                            onclick="removePrasadField({{ $loop->index }})">Remove</button>
                                    </div>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <input type="checkbox" name="offline_order" class="mt-1"
                                    {{ $templePrasad->offline_order ? 'checked' : '' }}> Do your Temple Provide Offline
                                Order
                            </div>
                        </div>
