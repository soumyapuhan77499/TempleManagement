            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <form action="{{ isset($niti) ? route('updateNitiMaster', $niti->id) : route('saveNitiMaster') }}"
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <!-- Niti Name -->
                                            <div class="col-md-3">
                                                <label class="form-label">Niti Name Odia</label>
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">Niti Name English</label>
                                                <input type="text" class="form-control" name="english_niti_name"
                                                    value="{{ old('english_niti_name', $niti->english_niti_name ?? '') }}"
                                                    placeholder="Enter Niti Name">
                                            </div>
                                            ...
                                            <div class="col-md-4 d-flex align-items-end gap-4">
                                                ...
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="nitiTypeSpecial">Special
                                                        Niti</label>
                                                </div>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" name="niti_type"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="niti_order"
                                                        name="niti_order"
                                                        value="{{ old('niti_order', $niti->niti_order ?? '') }}"
                                                        placeholder="Enter Niti Order">
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="input-group">
                                                            <span class="input-group-text"><i
                                                                    class="typcn typcn-calendar-outline"></i></span>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea class="form-control" name="niti_about" rows="2" placeholder="Enter Niti About">{{ old('niti_about', $niti->niti_about ?? '') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @empty
                                    <div class="row sub-niti-row align-items-center mb-3">
                                        ...
                                        <div class="col-md-2 mt-4 d-flex align-items-center">
                                            <button type="button" class="btn btn-success add-sub-niti me-2">Add</button>
                                            <button type="button" class="btn btn-danger remove-sub-niti"
                                                style="{{ $loop->first && count($subNitis) <= 1 ? 'display:none;' : '' }}">Remove</button>
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <label class="form-label">Description (Odia)</label>
                                <textarea class="form-control" name="description" placeholder="Enter Niti Description Odia">{{ old('description', $niti_master->description ?? '') }}</textarea>
                            </div>
                        </div>
                            <div class="card mb-3">
                            <div class="card-body">
                                <label class="form-label">Description (English)</label>
                                <textarea class="form-control" name="english_description" placeholder="Enter Niti Description English">{{ old('english_description', $niti_master->english_description ?? '') }}</textarea>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('click', function(event) {
            ...
            if (event.target.classList.contains('remove-sub-niti')) {
                ...
                if (allRows.length) {
                    allRows.forEach((r, i) => {
                        r.querySelector('.add-sub-niti').style.display = i === allRows.length - 1 ?
                            'inline-block' : 'none';
                        r.querySelector('.remove-sub-niti').style.display = allRows.length === 1 ? 'none' :
                            'inline-block';
                    });
                }
            }
