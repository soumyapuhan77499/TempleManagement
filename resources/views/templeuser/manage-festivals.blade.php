												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<form id="delete-form-{{ $festival->id }}" action="{{ route('templefestival.destroy', $festival->id) }}" method="POST" style="display:inline;">
																@csrf
																@method('DELETE')
																<button type="button" class="btn btn-danger" onclick="confirmDelete({{ $festival->id }})"><i class="fa fa-trash"></i></button>
															</form>
														</td>
													</tr>
													@endforeach
