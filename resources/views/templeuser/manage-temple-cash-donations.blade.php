                            ...
                            <div class="card-footer py-0">
                                <div class="profile-tab tab-menu-heading border-bottom-0">
                                    <nav class="nav main-nav-line p-0 tabs-menu profile-nav-line border-0 br-5 mb-0 full-width-tabs">
                                        <a class="nav-link mb-2 mt-2 {{ Request::is('templeuser/manage-temple-cash-donations') ? 'active' : '' }}" href="{{ route('templedonation.manage') }}"
                                        ...
                                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0">PAN Card</th>
                                                    <th class="border-bottom-0">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach($cashdonations as $key => $donation)
                                                <tr>
                                                    <td>{{ $key + 1 }}</td>
                                                    ...
                                                    <td>{{ $donation->pan_card }}</td>
                                                    <td>
                                                        <a href="{{ route('templedonation.edit', $donation->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                                       
                                                        <form id="delete-form-{{ $donation->id }}" action="{{ route('templedonation.destroy', $donation->id) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
